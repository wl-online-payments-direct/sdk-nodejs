const schema = {
  ...
  "properties" : {
    "cancelPayments" : {
      "type" : "array",
      "items" : {
        "$ref" : "#/definitions/cancelPaymentBatchRequest"
      },
      "uniqueItems" : false
    },
    "capturePayments" : {
      "type" : "array",
      "items" : {
        "$ref" : "#/definitions/capturePaymentBatchRequest"
      },
      "uniqueItems" : false
    },
    "createPaymentLinks" : {
    ...
    "header" : {
      "$ref" : "#/definitions/batchMetadata"
    },
    "refundPayments" : {
      "type" : "array",
      "items" : {
        "$ref" : "#/definitions/refundPaymentBatchRequest"
      },
      "uniqueItems" : false
    },
    "subsequentPayments" : {
      "type" : "array",
      "items" : {
        "$ref" : "#/definitions/subsequentPaymentBatchRequest"
      },
      "uniqueItems" : false
    }
  },
  ...
  "definitions" : {
    ...
    "subsequentPaymentBatchRequest" : {
      ...
      "properties" : {
        ...
        "subsequent" : {
          "$ref" : "#/definitions/subsequentPaymentRequest"
        }
      },
      "additionalProperties" : false
    },
